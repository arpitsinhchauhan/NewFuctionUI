...
public interface DieselSellRepository extends JpaRepository<Dieselsell, Integer> {
        ...
        Optional<Dieselsell> findSubsequentRecord(
                        @Param("pump") String pump,
                        @Param("date") String date,
                        @Param("shiftOrder") Integer shiftOrder,
                        @Param("currentId") Integer currentId,
