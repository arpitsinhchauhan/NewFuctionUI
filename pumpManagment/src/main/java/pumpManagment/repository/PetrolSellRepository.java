...
public interface PetrolSellRepository extends JpaRepository<PetrolSell, Integer> {
        ...
        Optional<PetrolSell> findSubsequentRecord(
                        @Param("pump") String pump,
                        @Param("date") String date,
                        @Param("shiftOrder") Integer shiftOrder,
                        @Param("currentId") Integer currentId,
