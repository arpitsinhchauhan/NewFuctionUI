 ...
 */
@Entity
@Table(name = "powerdiesel")
public class powerDiesel {
    ...
    @Column(name = "powerdiesel_ltr")
    private String powerdiesel_ltr;
    ...
    public String getPowerdiesel_ltr() {
        return powerdiesel_ltr;
    }

    public void setPowerdiesel_ltr(String powerdiesel_ltr) {
        this.powerdiesel_ltr = powerdiesel_ltr;
    }
    ...
    public List<powerDiesel> getRows() {
        return rows;
    }

    public void setRows(List<powerDiesel> rows) {
        this.rows = rows;
    }
